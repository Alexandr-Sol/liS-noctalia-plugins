...
QtObject {
    ...
    property var _upProc: Process {
        running: false
        onExited: (exitCode) => {
            Logger.i("AmneziaWG-dkms", "Up process exited with code: " + exitCode)
    ...
    property var _downProc: Process {
        running: false
        onExited: (exitCode) => {
            Logger.i("AmneziaWG-dkms", "Down process exited with code: " + exitCode)
            root.isLoading = false
            if (exitCode === 0) {
    ...
    function connect(name, config) {
        ...
        Logger.i("AmneziaWG-dkms", "Connecting with config: " + activeConfig)
    ...
    function disconnect() {
        ...
        Logger.i("AmneziaWG-dkms", "Disconnecting: " + configToUse)
    ...
    Component.onCompleted: {
        ...
        Logger.i("AmneziaWG-dkms", "Plugin started")
    }
}
